---
title: Next.jsを通じてSEO対策を学習する
date: 2024-05-06
summary: ブログ構築の参考サイトでSEOというワードが出てきたのでSEOについて知識を整理する。また、Next.jsの実装の説明が少ないため備忘録として記録する。
tags:
  - SEO
  - Next.js
---
...
今まで日付パスにしていましたが、日付＋キーワードキーワードでとなるようにパスを修正します。
